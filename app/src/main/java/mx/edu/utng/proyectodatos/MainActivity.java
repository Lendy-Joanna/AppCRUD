...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Los elementos del panel inferior no serán editables
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            ...
            case R.id.btnVer:
                //Si hay algún comentario seleccionado mostramos sus valores en la parte inferior
                if(c!=null){
            ...
            case R.id.btnEliminar:
                //Si hay algún comentario seleccionado lo borramos de la base de datos y actualizamos el spinner
                if(c!=null){
                    db.borrar(c.getId());
                    lista = db.getComments();
                    spinnerAdapter=new ArrayAdapter(this, android.R.layout.simple_spinner_dropdown_item, lista);
                    ...
                    //Eliminamos el comenterio actual puesto que ya no existe en base de datos
                    c=null;
                }
        }
    }
    ...
    public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
        if(parent.getId()==R.id.spinComentarios){
            ...
            //índice del elemento seleccionado en el spinner
            if(lista.size()>0){
